...
from scripts_ipssr_comparison import time_series_feature_extractor

extractor = time_series_feature_extractor.Feature_Extractor(snakemake.params[0], snakemake.params[1], snakemake.params[2])
